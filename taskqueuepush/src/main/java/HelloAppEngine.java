...
public class HelloAppEngine extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		queue.add(TaskOptions.Builder.withUrl("/pull"));
...
/**
 * adding a tag using tag which act as a filter q.add(
 * TaskOptions.Builder.withMethod(TaskOptions.Method.PULL)
 * .payload(content.toString()) .tag("process".getBytes()));
 * 
 * 
 * 
 * 
 * how to lease a task
 * 
 * // Lease only tasks tagged with "process" List<TaskHandle> tasks =
